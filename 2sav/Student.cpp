...
System::String^ Student::print1() {
    System::String^ name1 = gcnew String(name.c_str());
    System::String^ lastname1 = gcnew String(lastname.c_str());
    //System::String^ average1 = average.ToString();
    System::String^ grades1 = "";
    for (const auto& elem : grades) {
        grades1 = grades1 + " " + elem.ToString();
    }
    System::String^ studentas = name1 + " " + lastname1 + " " + grades1;

    return studentas;
}
System::String^ Student::print2() {
    System::String^ name1 = gcnew String(name.c_str());
    System::String^ lastname1 = gcnew String(lastname.c_str());
    System::String^ average1 = average.ToString();
    System::String^ studentas = name1 + " " + lastname1 + " " + average1;

    return studentas;
}
System::String^ Student::print3() {
    System::String^ name1 = gcnew String(name.c_str());
    System::String^ lastname1 = gcnew String(lastname.c_str());
    System::String^ median1 = median.ToString();
    System::String^ studentas = name1 + " " + lastname1 + " " + median1;

    return studentas;
}
System::String^ Student::print4() {
   // int average2=0;
    
   // average2 = average.ToInt32();
    int y = (int)round(average);
    System::String^ name1 = gcnew String(name.c_str());
    System::String^ lastname1 = gcnew String(lastname.c_str());
    System::String^ average1 = y.ToString();
    System::String^ studentas = name1 + " " + lastname1 + " " + y.ToString();
